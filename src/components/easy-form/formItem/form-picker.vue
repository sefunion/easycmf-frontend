  ...
  >
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <component
        ...
        @popup-visible-change="easyEvent.customeEvent(props.component, $event, 'onvVisibleChange')"
        @select-shortcut="easyEvent.customeEvent(props.component, $event, 'onSelectShortcut')"
...
const handlePickerChangeEvent = (value, date, dateString) => {
  easyEvent.handleChangeEvent(props.component, { value, date, dateString })
}

const handlePickerSelectEvent = (value, date, dateString) => {
  easyEvent.customeEvent(props.component, { value, date, dateString }, 'onSelect')
}

const handlePickerValueChangeEvent = (value, date, dateString) => {
  easyEvent.customeEvent(props.component, { value, date, dateString }, 'onPickerValueChange')
}

const handlePickerOkEvent = (value, date, dateString) => {
  easyEvent.customeEvent(props.component, { value, date, dateString }, 'onOk')
}
