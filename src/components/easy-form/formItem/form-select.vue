  ...
  >
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <a-select
        ...
        @remove="easyEvent.customeEvent(props.component, $event, 'onRemove')"
        @popup-visible-change="easyEvent.customeEvent(props.component, $event, 'onPopupVisibleChange')"
        @dropdown-scroll="easyEvent.handleCommonEvent(props.component, 'onDropdownScroll')"
        @dropdown-reach-bottom="easyEvent.handleCommonEvent(props.component, 'onDropdownReachBottom')"
        @exceed-limit="easyEvent.customeEvent(props.component, $event, 'onExceedLimit')"
...
const handleCascaderChangeEvent = async (value) => {
  ...
  if (component.onChange) {
    easyEvent.handleChangeEvent(component, value)
  }
