  ...
  >
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <a-input-tag
        ...
        @input-value-change="easyEvent.customeEvent(props.component, $event, 'onInputValueChange')"
        @change="easyEvent.handleChangeEvent(props.component, $event)"
        @remove="easyEvent.customeEvent(props.component, $event, 'onRemove')"
        @press-enter="easyEvent.customeEvent(props.component, $event, 'onPressEnter')"
