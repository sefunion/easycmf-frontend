<template>
  <div>
    <easy-image-upload v-if="props.type === 'image'" v-model="file" />
    <easy-file-upload v-if="props.type === 'file'" v-model="file" />
    <easy-chunk-upload v-if="props.type === 'chunk'" v-model="file" />
  </div>
</template>
<script setup>
...
import EasyImageUpload from './components/image-upload.vue'
import EasyFileUpload from './components/file-upload.vue'
import EasyChunkUpload from './components/chunk-upload.vue'
