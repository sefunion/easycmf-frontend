<template>
  <div class="lg:flex justify-between">
    <div class="easy-content-block p-5 h-full lg:w-1/2">
      <a-tabs
        type="rounded"
    ...
    <div class="easy-content-block p-5 h-full lg:w-1/2 lg:ml-3 mt-3 lg:mt-0" v-if="$common.auth(['setting:config:save'])">
...
<script setup>
  ...
  const handleChange = (key) => {
    ...
    easyFormRef.value[params[0]].init()
    active.value = key
  }
  ...
  getConfigGroupList()
  nextTick(() => easyFormRef.value && easyFormRef.value[0].init() )
</script>
<script>
