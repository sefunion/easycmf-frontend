<template>
  <div class="flex justify-between">
    <div class="easy-content-block rounded-sm flex justify-between w-full p-3">
      <div class="pl-0 flex inline-block">
        ...
        <div class="pl-3 mt-2">
          ...
          <div class="leading-5 mt-2">
            ...
            欢迎使用EasyCMF后台权限管理系统，系统开源、免费使用。喜欢的请点个 ⭐Star。
            <a-space size="large">
    ...
    <a-modal :footer="false" v-model:visible="visible">
      ...
      <a-image src="https://doc.easycmf.cn/qrcode.jpg" />
    </a-modal>
  </div>
</template>
