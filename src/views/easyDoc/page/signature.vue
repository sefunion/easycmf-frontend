<template>
  <div class="work-area p-5">
    <div class="easy-content-block shadow p-5">
      <div class="text-2xl">简易模式</div>
      <div class="easy-content-block shadow p-5 mt-5 leading-10">
    ...
    <div class="easy-content-block shadow p-5 mt-5">
      ...
      <div class="easy-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          <div>
            一、组合签名数据格式
            <easy-code-editor v-model="obj" height="120" readonly />
          </div>
          <div>
            二、根据字段名降序排序，组合http原始字符串
            <easy-code-editor v-model="text" height="60" readonly />
          </div>
          <div>
            三、md5 http原始字符串，完成生成 <a-tag color="purple">signature</a-tag>
            <easy-code-editor v-model="text2" height="60" readonly />
          </div>
        </div>
      </div>
      ...
      <div class="easy-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          ...
          <div class="mt-5">
            组合完整请求参数
            <easy-code-editor v-model="obj2" height="100" readonly />
          </div>
        </div>
      </div>
