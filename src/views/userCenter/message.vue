...
<template>
  <div class="easy-content-block p-3 lg:h-full block lg:border-0 lg:flex justify-between">
    ...
    <div class="h-hull w-full lg:ml-3 lg:mr-2 pt-2">
      <easy-crud :options="crud" :columns="columns" ref="crudRef">
    ...
    <a-modal v-model:visible="receiveListVisible" width="1000px">
      ...
      <easy-crud :options="receiveCrud" :columns="receiveColumns" ref="receiveCrudRef" />
    </a-modal>
  </div>
