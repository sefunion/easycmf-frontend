<template>
  <div class="flex justify-between tags-container" ref="containerDom" v-if="appStore.tag">
    <div class="menu-tags-wrapper" ref="scrollbarDom" :class="{ 'tag-pn': tagShowPrevNext }">
      ...
      <span class="easy-tag-prev" v-if="tagShowPrevNext">
        <IconLeft :size="20" class="tag-scroll-icon" @click="handleScroll(-500)" />
      </span>
      <span class="easy-tag-next" v-if="tagShowPrevNext">
        <IconRight :size="20" class="tag-scroll-icon" @click="handleScroll(500)" />
      </span>
    </div>
    <a-trigger class="easy-tags-more-dropdown" :popup-translate="[-65, -6]" :show-arrow="true" trigger="hover">
      <span class="easy-tags-more">
        <span class="easy-tags-more-icon">
          <i class="easy-box easy-box-t"></i>
          <i class="easy-box easy-box-b"></i>
        </span>
      </span>
      <template #content>
        <ul class="easy-tags-more-contextmenu">
...
<style scoped lang="less">
  ...
  .easy-tags-more:hover .easy-tags-more-icon .easy-box:before {
    background: rgb(var(--primary-6));
    transform: rotate(45deg);
  }

  .easy-tags-more:hover .easy-tags-more-icon .easy-box:after {
    background: rgb(var(--primary-6));
  }

  .easy-tags-more:hover .easy-tags-more-icon {
